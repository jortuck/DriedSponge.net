    ...
    <div class="container-fluid-lg" style="padding-top: 80px;">
            ...
            <div class="container">
                    ...
                    <h4 class="subheading" id="as">Addon Structure</h4>
                        ...
                        <img  class="img-fluid" src="https://i.driedsponge.net/images/png/1sIid.png" alt="GMOD Directory" />
                        ...
                        <img class="img-fluid" src="https://i.driedsponge.net/images/png/D8vIT.png" alt="Addon Directory" />    
                        ...
                        <img class="img-fluid" src="https://i.driedsponge.net/images/png/UsZGD.png" alt="Lua Directory" />
                        ...
                        <img class="img-fluid" src="https://i.driedsponge.net/images/png/Q1fC4.png" alt="Client/Server Directory" />
                        ...
                        <img class="img-fluid" src="https://i.driedsponge.net/images/png/ZIytg.png" alt="Client/Server Directory" />
                        ...
                        <img class="img-fluid" src="https://i.driedsponge.net/images/gif/unkbn.gif" alt="Client/Server files" />
                    ...
                    <img class="img-fluid" src="https://i.driedsponge.net/images/png/3BKVa.png" alt="print functions" />
                    ...
                    <img class="img-fluid" src="https://i.driedsponge.net/images/gif/Wr5dz.gif" alt="print functions in console" />
                    ...
                    <img class="img-fluid" src="https://i.driedsponge.net/images/png/oitVe.png" alt="variable example"/>
                    ...
                    <img class="img-fluid" src="https://i.driedsponge.net/images/png/ybqL4.png" alt="variable print example code"/>
                    <img class="img-fluid" src="https://i.driedsponge.net/images/png/fyO5j.png" alt="variable print example"/>
                    ...
                    <img class="img-fluid" src="https://i.driedsponge.net/images/png/hZ4g3.png" alt="concatenation print example code"/>
                    <img class="img-fluid" src="https://i.driedsponge.net/images/png/5mmAv.png" alt="concatenation print example"/>
