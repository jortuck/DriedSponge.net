                    ...
                    <div class="container">
                        <div class="row display-flex">
                            <div class="col indexcol">
                                <div class="card card-border">
                                    <div class="card-body">
                                        <img data-src="<?=v(url());?>img/html.png" alt="html5logo" class="img-fluid lozad"
                            ...
                            <div class="col indexcol">
                                <div class="card card-border">
                                    <div class="card-body">
                                        <img data-src="<?=v(url());?>img/lua.png" alt="lualogo"  class="img-fluid lozad"
                                            style="max-height:100px;" />
                            ...
                            <div class="col indexcol">
                                ...
                                <div class="card card-border">
                                    <div class="card-body">
                                        <img data-src="<?=v(url());?>img/php.png" alt="phplogo"  class="img-fluid lozad"
                                            style="max-height:100px;" />
                        ...
                        <div class="row display-flex">
                            <div class="col indexcol">
                                <div class="card card-border">
                                    <div class="card-body">
                                        <img data-src="<?=v(url());?>img/css.png" alt="csslogo"  class="img-fluid lozad"
                                            style="max-height:100px;" />
                            ...
                            <div class="col indexcol">
                                ...
                                <div class="card card-border">
                                    <div class="card-body">
                                        <img data-src="<?=v(url());?>img/js.png" alt="jslogo"  class="img-fluid lozad"
                                            style="max-height:100px;" />
