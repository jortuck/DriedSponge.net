		...
		<section class="space-y-12">
			...
			<div class="space-y-4">
				...
				<div class="my-3 grid grid-cols-1 gap-3 md:grid-cols-2">
					<div
						class="from-base-150 flex flex-col rounded-md border-2 border-base-300 bg-gradient-to-br to-base-100"
					>
						<div class="m-2 flex-1 space-y-2">
							<div class="space-x-2">
								<h4 class="text-xl font-bold text-white md:text-2xl">
					...
					<div class="flex flex-col rounded-md border-2 border-base-300">
						<div class="m-2 flex-1 space-y-2">
							<div class="space-x-2">
								<h4 class="text-xl font-bold text-white md:text-2xl">
