    ...
    <div class="page-footer" style="text-align: center; background-color:#007BFF;">
            <h4><em style="color: white;">Socials</em></h4>
                       ...
                       <button type="button" class="btn btn-success" data-toggle="modal" data-tippy-content="Discord" data-target="#keymodal"><i class="fab fa-discord fa-2x"></i></button>
                        ...
                        <p><cite>Copyright © 2019 Jordan Tucker &bull; Thanks to eveyone in <a href="https://discord.gg/HfgcZKs" target="_blank" class="whitehyperlink" >Rainns Discord</a> for giving me insights on how this site should look &bull; Contact: jordantucker@driedsponge.net</cite></p>
        </div>
      </footer>
